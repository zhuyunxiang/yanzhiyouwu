...
if (!$smarty->is_cached('size.dwt', $cache_id))
{
    assign_template();
    ...
    if (!empty($cat_recommend_res))
    {
        ...
        {
            $cat_rec[$cat_recommend_data['recommend_type']][] = array('cat_id' => $cat_recommend_data['cat_id'], 'cat_name' => $cat_recommend_data['cat_name'],'cat_url'=>build_uri('category',array('cid'=>$cat_recommend_data['cat_id'])));
        }
...
$smarty->display('size.dwt', $cache_id);
