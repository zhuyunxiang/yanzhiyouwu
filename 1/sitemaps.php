...
if (file_exists(DATA_DIR  . '/sitemap.dat') && time() - filemtime(DATA_DIR  . '/sitemap.dat') < 86400)
{
    $out = file_get_contents(DATA_DIR  . '/sitemap.dat');
}
else
{
    ...
    file_put_contents(DATA_DIR  . '/sitemap.dat', $out);
}
