...
function insert_cart_info()
{
	...
	else
	{
		...
		return "欢迎光临衣天下&nbsp;&nbsp;" .
		'<a href="flow.php" title="' . $GLOBALS['_LANG']['view_cart'] . '">' . $str . "</a>";
	}		
